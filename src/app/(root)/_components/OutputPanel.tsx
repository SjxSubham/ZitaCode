    ...
    <div className="relative shadow-2xl bg-gray-400/50 dark:bg-[#181825] rounded-xl p-7 ring-1 ring-gray-100 dark:ring-gray-800/50">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold dark:font-medium dark:text-gray-300">
            Output
          </span>
        </div>
          ...
          {isRunning ? (
            ...
            <div className="flex items-start gap-3 text-red-400">
              ...
              <div className="space-y-1">
                ...
                <pre className="whitespace-pre-wrap text-red-400/50 dark:text-red-400/80">
                  {error}
                </pre>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <pre className="whitespace-pre-wrap text-[#1e1e2e]/100 dark:text-gray-300">
                {output}
              </pre>
            </div>
          ) : (
