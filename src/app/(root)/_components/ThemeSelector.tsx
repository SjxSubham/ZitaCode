...
import { CircleOff, Cloud, CloudMoonRain, Github, Laptop, Moon, Palette, SprayCan, Sun } from "lucide-react";
...
const THEME_ICONS: Record<string, React.ReactNode> = {
  ...
  "night-owl": <CloudMoonRain  className="size-4" />,
  "nord": <SprayCan className="size-4" />, 
};
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-48 group relative flex justify-between items-center gap-2 px-2 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      >
        ...
        <span className="text-left font-medium text-gray-300 group-hover:text-white transition-colors">
          {currentTheme?.label}
        </span>
