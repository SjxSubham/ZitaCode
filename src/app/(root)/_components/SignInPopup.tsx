  ...
  return (
    <SignedOut>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md dark:bg-gradient-to-br from-gray-900 to-gray-950 border-gray-700">
          <DialogHeader className="text-center space-y-3 items-center justify-center">
            <div className="size-11 text-blue-400 transform dark:-rotate-2 group-hover:rotate-0 transition-transform duration-500">
              <img src="/Image...webp" alt="ZitaCode" className="rounded-md" />
            </div>
            <DialogTitle className="text-2xl font-bold dark:text-white">
              Welcome to ZitaCode!
            </DialogTitle>
            <DialogDescription className="dark:text-gray-300 text-gray-800 text-base">
              Sign in to unlock the full power of our code editor. Get access to
              advanced features, save your projects, and join our community of
              developers.
            </DialogDescription>
          </DialogHeader>
          ...
          <button
            onClick={handleClose}
            className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-gray-200 hover:text-white"
          >
