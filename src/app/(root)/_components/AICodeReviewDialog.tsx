...
export function AICodeReviewDialog({ isOpen, onClose, code, language }: AICodeReviewDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="min-w-fit justify-between items-center max-h-[80vh] overflow-y-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg custom-scrollbar">
