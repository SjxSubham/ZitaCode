      ...
      ring-white/10 group-hover:ring-white/20 transition-all"
        ...
        to-purple-500/10 opacity-0 group-hover:opacity-50 transition-opacity"
         ...
         transition-colors "
          ...
          to-blue-500/10 opacity-0 group-hover:opacity-50 transition-opacity"
                />
                <FolderGit2 className="w-4 h-4 relative z-10 sm:w-4 sm:h-4 group-hover:rotate-3 transition-transform" />
                <span
                  className="text-sm font-medium relative z-10 group-hover:shadow-purple-400
           transition-colors "
                >
                  Buckets
                </span>
