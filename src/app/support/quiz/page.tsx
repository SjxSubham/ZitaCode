    ...
    if (selectedAnswer) {
      ...
      const isCorrect =
        currentQuestion.correct_answers[
          `answer_${selectedAnswer}_correct` as keyof QuizQuestion["correct_answers"]
        ] === "true";
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <Button
                ...
                disabled={
                  !selectedCategory ||
                  (selectedCategory === "Code" && !selectedTag)
                }
              >
                Start Quiz
              </Button>
          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-lg">
                  You answered {score / 20} out of {questions.length} questions
                  correctly!
                </p>
                <Button
                  onClick={() => {
